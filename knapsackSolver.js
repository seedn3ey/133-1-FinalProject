 ...
 * knapsackSolver.js
 * -----------------------------------------------------------------------
 * Dedicated Dynamic Programming module for the 0/1 Knapsack Problem.
 * This module contains ONLY the algorithmic logic — it does not read
 * input, print output, or know anything about "relief operations".
 * That separation keeps the algorithm reusable, testable, and easy to
 * reason about independently of the Main Controller.
 *
 * Time complexity:  O(n * W)
 * Space complexity: O(n * W)
 *   where n = number of items, W = maximum vehicle capacity
 * -----------------------------------------------------------------------
 */

/**
 * Builds the Dynamic Programming table.
 * dpTable[i][j] = the maximum priority score achievable using only the
 * first i items, within a weight capacity of j.
 *
 * @param {Array<{weight:number, priority:number}>} items
 * @param {number} maxCapacity
 * @returns {number[][]} the fully populated DP table
 */
